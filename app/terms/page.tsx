...
export const metadata: Metadata = {
  title: 'Terms of Service | FARE',
  description: 'Terms of Service for FARE - Livestock Farm Management Software',
}
        ...
        <div className="prose prose-slate max-w-none">
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed">
              By purchasing and using FARE (Farm Animal Record & Expense tracking), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not purchase or use the software.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Upon payment of the one-time license fee ($99), you are granted a non-exclusive, non-transferable, lifetime license to use FARE software.
            </p>
            ...
            <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-4">
              <li>Install FARE on up to 3 devices for your farm&apos;s use</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              FARE is sold for a one-time payment of $99 USD. This grants you lifetime access to the software with no recurring fees or subscriptions.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              We offer a 30-day money-back guarantee. If you are not satisfied with FARE for any reason, request a refund within 30 days of purchase for a full refund. See our{' '}
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              FARE stores all your data locally on your device. You are solely responsible for:
            </p>
            <ul className="list-disc pl-6 text-slate-600 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              FARE is provided &quot;as is&quot; without warranty of any kind, express or implied. We do not guarantee that:
            </p>
            <ul className="list-disc pl-6 text-slate-600 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              As a user of FARE, you are responsible for:
            </p>
            <ul className="list-disc pl-6 text-slate-600 space-y-2">
          ...
          <section className="mb-8">
            <p className="text-slate-600 leading-relaxed italic">
              By using FARE, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
            </p>
          </section>
        </div>
      </div>
